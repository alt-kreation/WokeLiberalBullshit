...
namespace FishingIsland
{
	public class GridMovement2D : MonoBehaviour
	{
		...
		{
			float horizontalInput = InputHandler.FishingActions.Overworld.Move.ReadValue<Vector2>().x;
			float verticalInput = InputHandler.FishingActions.Overworld.Move.ReadValue<Vector2>().y;
